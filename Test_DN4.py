...
#要改
model_trained = '/public/home/yan/DN4_原版/DN4-master/results_CN/SGD_Cosine_Lr0.05_k=3_CN0704res12DN4_ResNet12_Epoch_50_miniImageNet_84_84_5Way_1Shot'


parser = argparse.ArgumentParser()
parser.add_argument('--dataset_dir', default='/data1/Liwenbin/Datasets/miniImageNet--ravi', help='/miniImageNet--ravi')
...
parser.add_argument('--outf', default='./results_CN/')
parser.add_argument('--resume', default=model_trained, type=str, help='path to the lastest checkpoint (default: none)')
parser.add_argument('--encoder_model', default='ResNet12', help='Conv64F|Conv64F_Local|ResNet10|ResNet12|ResNet18')
parser.add_argument('--classifier_model', default='DN4', help='ProtoNet|DN4')
...
if __name__=='__main__':
	...
	for r in range(repeat_num):
		...
		with torch.no_grad():
			prec1, test_loss, accuracies = test(test_loader, model, criterion, epoch_index, best_prec1, F_txt_test)
